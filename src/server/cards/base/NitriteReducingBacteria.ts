    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.resource(CardResource.MICROBE, 3).arrow().tr(1).br;

          b.plainText('Action: Add 1 microbe to this card, or remove 3 microbes to increase your TR 1 step.', /* parens */ true);
          b.br;
